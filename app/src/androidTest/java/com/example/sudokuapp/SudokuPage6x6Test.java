...
public class SudokuPage6x6Test {
    ...
    public void manualModeCheck() throws InterruptedException{
        ...
        Thread.sleep(500);
        //confirm no change
        assertNotEquals("invalid input should not change the text of the cell.", " ", emptyCell.getText().toLowerCase());
    ...
    public void combinationCheck() throws InterruptedException {
        ...
        assertEquals(categoryButton.getText().toLowerCase(), "CATEGORIES".toLowerCase());
        categoryButton.click();
